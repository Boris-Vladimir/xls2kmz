...
class FirstRowChecker(object):
    '''
    Check if the first four columns of the first row of the 
    Excel file are: 'latitude', 'longitude', 'name' and
    'description'
    '''
    def __init__(self, first_row):
        '''
        list -> FirstRowChecker() object
    ...
    def check(self):
        ...
        Returns True if the first four columns of the first
        row of the Excel file are 'latitude', 'longitude',
