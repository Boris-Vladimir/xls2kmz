...
class KmlJoiner(object):
    ...
    def __init__(self, list_of_kmls, original_path):
        '''
        list, string -> KmlJoiner object

        list_of_kmls - a list of paths of the kml files
        original_path - a string with the original working directory path
        '''
    ...
    def __join_docs(self, doc_list):
        ...
        doc_list - a list of string of the path of the kml files
    ...
    def __kml_parser(self, doc):
        ...
        doc - a string containing the path to the doc to parse
